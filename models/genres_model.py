genres = {
    "anime": [
        'anime', 'anime score', 'j-pop', 'j-poprock', 'j-rock', 'japanese emo', 'japanese pop punk', 'otacore'
    ],
    "blues": [
        'blues', 'blues rock', 'electric blues', 'modern blues', 'texas blues'
    ],
    "classical": [
        'baroque', 'classical', 'early music', 'german baroque', 'early romantic era', 'polish classical',
        'classical era', 'german romanticism'
    ],
    "disco": [
        'disco', 'post-disco', 'quiet storm'
    ],
    "eletronic": [
